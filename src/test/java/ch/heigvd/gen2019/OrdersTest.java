...
public class OrdersTest {
    ...
    public void OneOrderWithOneProduct() {
        order111.AddProduct(new Product("Shirt", ProductColor.BLUE, ProductSize.M, 2.99, Currency.TWD));
    ...
    public void OneOrderWithOneProductNoSize() {
        order111.AddProduct(new Product("Pot", ProductColor.RED, ProductSize.NOT_APPLICABLE, 16.50, Currency.SGD));
